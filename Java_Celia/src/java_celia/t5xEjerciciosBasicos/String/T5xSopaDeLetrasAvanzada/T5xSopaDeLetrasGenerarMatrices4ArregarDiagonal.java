 ...
 * @author Portatil_Bot
 */
public class T5xSopaDeLetrasGenerarMatrices4ArregarDiagonal {

    private static char[][] matriz;

    public static void main(String[] args) {
        GenerarMatrices4 gm = new GenerarMatrices4();
...
class GenerarMatrices4 implements SopaDeLetraMatriz {
