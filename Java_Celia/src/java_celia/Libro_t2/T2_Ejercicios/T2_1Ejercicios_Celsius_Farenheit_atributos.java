...
public class T2_1Ejercicios_Celsius_Farenheit_atributos {
    ...
    public static double get_temperature() {
        ...
        try {
            ...
            Logger.getLogger(T2_1Ejercicios_Celsius_Farenheit_atributos.class.getName()).log(Level.SEVERE, null, ex);
        }
        return value;
    }
