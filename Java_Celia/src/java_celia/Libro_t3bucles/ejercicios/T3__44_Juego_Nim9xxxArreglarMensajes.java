...
public class T3__44_Juego_Nim9xxxArreglarMensajes {
...
//                            System.out.println("Ⓞ Palillos ingresados : " + palillosCogidos);
//                            System.out.println("Ⓞ En el monton " + MONTON1 + " hay " + palillosDelMonton1 + " palillos");
//                            System.out.println("Ⓞ El 'ORDENADOR' vuelve a elegir palillos que sean menores de " + palillosDelMonton1 + " Ⓞ ");
                            int palillosMenores = (int) (Math.random() * (0 + 2) + 1);
//                            System.out.println("Ⓞ Valor asignado : " + palillosMenores + " Ⓞ ");
...
//                            System.out.println("Ⓞ Palillos ingresados : " + palillosCogidos);
//                            System.out.println("Ⓞ En el monton " + MONTON2 + " hay " + palillosDelMonton2 + " palillos");
//                            System.out.println("Ⓞ El 'ORDENADOR' vuelve a elegir palillos que sean menores de " + palillosDelMonton2 + " Ⓞ ");
                            int palillosMenores = (int) (Math.random() * (0 + 2) + 1);
//                            System.out.println("Ⓞ Valor asignado : " + palillosMenores + " Ⓞ ");
                            palillosCogidos = palillosMenores;
                        }
...
//                            System.out.println("Ⓞ Palillos ingresados : " + palillosCogidos);
//                            System.out.println("Ⓞ En el monton " + MONTON3 + " hay " + palillosDelMonton3 + " palillos");
//                            System.out.println("Ⓞ El 'ORDENADOR' vuelve a elegir palillos que sean menores de " + palillosDelMonton3 + " Ⓞ ");
                            int palillosMenores = (int) (Math.random() * (0 + 2) + 1);
//                            System.out.println("Ⓞ Valor asignado : " + palillosMenores);
                            palillosCogidos = palillosMenores;
                        }
