...
public class T3__44_Juego_Nim9xxArreglarFallos2 {
...
//    Almacena la cantidad de palillos que tiene cada Monton
     ...
     * @return true o false
     */
    public static boolean XcomprobarMonton(int monton) {

        boolean montonConPalillos = false;

        System.out.println("♠ Comprobar Monton ♠");

        if (MONTON1 == monton && (palillosDelMonton1 > 0)) {
            System.out.println("♠ Monton: " + MONTON1 + " con : " + palillosDelMonton1 + " palillos ♠");
            montonConPalillos = true;
        }

        if (MONTON2 == monton && (palillosDelMonton2 > 0)) {
            System.out.println("♠ Monton: " + MONTON2 + " con : " + palillosDelMonton2 + " palillos ♠");
            montonConPalillos = true;
        }

        if (MONTON3 == monton && (palillosDelMonton3 > 0)) {
            System.out.println("♠ Monton: " + MONTON3 + " con : " + palillosDelMonton3 + " palillos ♠");
            montonConPalillos = true;
        }
