...
public class T3__35NumeroLetra {
    ...
    public static int getMs2() {
        ...
        if (dMs > 1) {
            ...
            if (ms == 1) {
                System.out.println("♦ y un mil");
            }
            if (ms == 2) {
                System.out.println("♦ y dos mil");
            }
            if (ms == 3) {
                System.out.println("♦ y tres mil");
            }
            if (ms == 4) {
                System.out.println("♦ y cuatro mil");
            }
            if (ms == 5) {
                System.out.println("♦ y cinco mil");
            }
            if (ms == 6) {
                System.out.println("♦ y seis mil");
            }
            if (ms == 7) {
                System.out.println("♦ y siete mil");
            }
            if (ms == 8) {
                System.out.println("♦ y ocho mil");
            }
            if (ms == 9) {
                System.out.println("♦ y nueve mil");
            }
        }
        return ms;
    }
    ...
    public static int getCs() {
        ...
        if (cs == 9) {
            System.out.println("☻ novencientos");
        }
        return cs;
    }
