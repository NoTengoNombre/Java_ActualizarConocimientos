...
//        int sumaTotal = 29;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Division : " + dividirAnioGeneral(1999));
        int anioDividido = dividirAnioGeneral(1999);
        ...
        int dividir2cifrasDia = dividir2cifrasDia(1);
