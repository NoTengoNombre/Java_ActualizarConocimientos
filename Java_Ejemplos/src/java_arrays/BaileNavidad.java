/**
 * @created on : 05-sep-2017, 22:45:00
 * @see
 * @since
 * @version
...
/**
 * Esta clase asigna aleatoriamente parejas de baile para las tres escuelas de
 * magia de Harry Potter y El Cáliz de Fuego. Se supone que hay un número igual
 * de estudiantes en cada escuela, y que las parejas tienen que ser de
...
public class BaileNavidad {
     ...
     *
     * @return La lista de parejas de baile como un array bidimensional. La
     * columna [0] contiene a los chicos y la [1] las chicas.
     */
    ...
    /**
     * Crea las listas de estudiantes de cada colegio. Este método debería tomar
     * los datos de un fichero o de una base de datos... pero aún no sabemos
     * hacer tal cosa, así que lo teclearemos todo en plan artesanal.
     */
    public static void crearListasEstudiantes() {
        ...
        // Creamos los estudiantes (esta información que podría tomarse de un fichero, o de una base de datos, etc)
...
/**
 * Clase Estudiante Cada uno de los estudiantes de Hogwarts.
 */
class Estudiante {
