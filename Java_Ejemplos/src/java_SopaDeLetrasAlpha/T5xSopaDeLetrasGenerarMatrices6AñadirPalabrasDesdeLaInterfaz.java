 ...
 * @author Portatil_Bot
 */
public class T5xSopaDeLetrasGenerarMatrices6AñadirPalabrasDesdeLaInterfaz {

}

class GenerarMatrices6 implements SopaDeLetraMatriz {
    ...
    public char[][] setArrayVertical(char[][] matriz, String palabra, int paramFila, int paramColumna) {
        ...
        if ((paramFila > (matriz.length - palabraTroceada.length)) || (matriz.length < palabraTroceada.length) || (paramColumna > 9)) {
            System.out.println("○ Elije otra palabra Vertical");
        } else {
            int indice = 0;
...
//Controla la posicion de la columna donde quiero que este 
    ...
    public static void main(String[] args) {
        GenerarMatrices6 gm = new GenerarMatrices6();
...
//        matriz = gm.setArrayVertical(matriz, "GATO", 0, 0);
        matriz = gm.setArrayVertical(matriz, "RANA", 0, 0);
