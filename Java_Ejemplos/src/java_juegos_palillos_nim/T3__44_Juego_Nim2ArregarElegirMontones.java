...
public class T3__44_Juego_Nim2ArregarElegirMontones {
     ...
     *
     */
    private static int setElegirMontonUsuario() {
        setCrearMontones();
        System.out.println("▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁");
        ...
        if (elegirMonton == 1) {
            ...
            System.out.println("◘ El 'Humano' eligio el monton " + elegirMonton + " con " + monton + " palillos ");
            return elegirMonton; // monton seleccionado e incluye la cantidad de palillos
        }
        if (elegirMonton == 2) {
    ...
    private static int setElegirMontonOrdenador() {
        ...
        if (elegirMonton == 1) {
            monton = monton1palillos;
            System.out.println("♨ El 'ORDENADOR' eligio el monton " + elegirMonton + " tiene : " + monton + " palillos ♨");
            return elegirMonton; // monton seleccionado e incluye la cantidad de palillos
        }
        if (elegirMonton == 2) {
            monton = monton2palillos;
    ...
    public static int getElegirPalillos(int pTurno) {
        ...
        if (pTurno == 1) {
            devolverNumeroMonton = setElegirMontonUsuario();

        }
        if (pTurno == 2) {
            devolverNumeroMonton = setElegirMontonOrdenador();
