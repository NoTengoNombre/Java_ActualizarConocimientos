...
public class T3__44_Juego_Nim9CogerPalillosOrdenador {
    ...
    private static int elegirMonton(int turno) {
        ...
        if (turno == 2) {
            ...
            do {
                ...
                if (montonPalillos1 <= 0) {
                    pararOrdenador = true;
                }
                if (montonPalillos2 <= 0) {
                    pararOrdenador = true;

                }
                if (montonPalillos3 <= 0) {
                    pararOrdenador = true;
                }

                System.out.println("Numero de palillos : " + numPalillos);

            } while (numPalillos <= 1 && pararOrdenador == false);
    ...
    public static boolean comprobarMonton(int montElegido) {
        ...
        if (turno == 2) {
            System.out.println("soy ordenador : " + turno);
        }
